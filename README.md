...
* [Xcode](https://developer.apple.com/xcode/) you will spend most of your time with it
  * [iOS-DeviceSupport](https://github.com/iGhibli/iOS-DeviceSupport/tree/master/DeviceSupport) ⭐ 8,220 | 🐛 141 | 🌐 Python | 📅 2023-06-09 This repository holds the device support files for the iOS, and I will update it regularly.
...
* [Carthage](https://github.com/Carthage/Carthage) ⭐ 15,161 | 🐛 217 | 🌐 Swift | 📅 2025-09-10 A simple, decentralized dependency manager for Cocoa
...
* [CocoaPods](http://cocoapods.org/) dependency manager for Swift and Objective-C Cocoa projects
  ...
  * [cocoapods-dependencies](https://github.com/segiddins/cocoapods-dependencies) ⭐ 254 | 🐛 7 | 🌐 Ruby | 📅 2023-02-13 Shows a project's CocoaPods dependency graph
...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,706 | 🐛 332 | 🌐 Shell | 📅 2026-09-14 A delightful community-driven (with 1,300+ contributors) framework for managing your zsh configuration.
* [brew](https://github.com/Homebrew/brew) ⭐ 49,613 | 🐛 4 | 🌐 Ruby | 📅 2026-09-14 🍺 The missing package manager for macOS
* [tmux](https://github.com/tmux/tmux) ⭐ 49,244 | 🐛 37 | 🌐 C | 📅 2026-09-14 tmux is a "terminal multiplexer", it enables a number of terminals (or windows)
  to be accessed and controlled from a single terminal.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,532 | 🐛 27 | 🌐 Perl | 📅 2026-09-14 cloc counts blank lines, comment lines, and physical lines of source code in many programming languages.
* [autojump](https://github.com/wting/autojump) ⭐ 16,960 | 🐛 231 | 🌐 Python | 📅 2025-02-27 A cd command that learns - easily navigate directories from the command line
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,929 | 🐛 292 | 🌐 Swift | 📅 2026-09-09 A code library and command-line formatting tool for reformatting Swift code
* [XcodeGen](https://github.com/yonaskolb/XcodeGen) ⭐ 8,773 | 🐛 398 | 🌐 Swift | 📅 2026-09-13 A Swift command line tool for generating your Xcode project
* [Jazzy](https://github.com/realm/jazzy) ⭐ 7,378 | 🐛 76 | 🌐 Ruby | 📅 2026-09-14 Soulful docs for Swift & Objective-C
...
* [synx](https://github.com/venmo/synx) ⭐ 6,038 | 🐛 56 | 🌐 Ruby | 📅 2019-07-18 A command-line tool that reorganizes your Xcode project folder to match your Xcode groups
* [idb](https://github.com/facebook/idb) ⭐ 5,329 | 🐛 182 | 🌐 Swift | 📅 2026-09-14 idb is a flexible command line interface for automating iOS simulators and devices
* [xcpretty](https://github.com/supermarin/xcpretty) ⭐ 4,035 | 🐛 120 | 🌐 Ruby | 📅 2025-03-26 Flexible and fast xcodebuild formatter
* [swift-argument-parser](https://github.com/apple/swift-argument-parser) ⭐ 3,766 | 🐛 144 | 🌐 Swift | 📅 2026-09-13 Open-source library that makes it straightforward to parse command-line arguments in Swift
...
* [Kin](https://github.com/Karumi/Kin) ⭐ 1,064 | 🐛 4 | 🌐 Python | 📅 2026-08-10 Simple PBXProj Verifier (If you has problem to git merge the project.pbxproj file)
...
* [xcproj](https://github.com/0xced/xcproj) ⭐ 320 | 🐛 3 | 🌐 Objective-C | 📅 2024-05-29 Command line tool for manipulating Xcode project files
...
* [DoraemonKit](https://github.com/didi/DoraemonKit) ⭐ 20,398 | 🐛 275 | 🌐 Java | 📅 2026-09-07 A full-featured App (iOS & Android) development assistant.
* [FLEX](https://github.com/Flipboard/FLEX) ⭐ 14,635 | 🐛 50 | 🌐 Objective-C | 📅 2026-06-11 An in-app debugging and exploration tool for iOS
* [CocoaLumberjack](https://github.com/CocoaLumberjack/CocoaLumberjack) ⭐ 13,319 | 🐛 7 | 🌐 Objective-C | 📅 2026-08-12 A fast & simple, yet powerful & flexible logging framework for Mac and iOS
* [matrix](https://github.com/Tencent/matrix) ⭐ 12,046 | 🐛 408 | 🌐 Java | 📅 2024-07-23 Matrix is a plugin style, non-invasive APM system developed by WeChat.
...
* [spy-debugger](https://github.com/wuchangming/spy-debugger) ⭐ 7,615 | 🐛 106 | 🌐 JavaScript | 📅 2025-09-01 WebView,WeChat WebView,Safari Debugger
...
* [NWPusher](https://github.com/noodlewerk/NWPusher) ⭐ 6,301 | 🐛 28 | 🌐 Objective-C | 📅 2021-03-30 OS X and iOS application and framework to play with the Apple Push Notification service (APNs)
* [ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,204 | 🐛 20 | 🌐 C | 📅 2025-07-02 A DevTools proxy (Chrome Remote Debugging Protocol) for iOS devices (Safari Remote Web Inspector).
* [PonyDebugger](https://github.com/square/PonyDebugger) ⭐ 5,849 | 🐛 46 | 🌐 Objective-C | 📅 2023-03-18Remote network and data debugging for your native iOS app using Chrome Developer Tools
...
* [KSCrash](https://github.com/kstenerud/KSCrash) ⭐ 4,492 | 🐛 21 | 🌐 Objective-C | 📅 2026-09-14 The Ultimate iOS Crash Reporter
* [GodEye](https://github.com/zixun/GodEye) ⭐ 3,881 | 🐛 10 | 🌐 Swift | 📅 2024-09-22 Automaticly display Log,Crash,Network,ANR,Leak,CPU,RAM,FPS,NetFlow,Folder and etc with one line of code based on Swift. Just like God opened his eyes
* [dSYMTools](https://github.com/answer-huang/dSYMTools) ⭐ 3,469 | 🐛 1 | 🌐 C | 📅 2025-10-25 Analyze crash log with DSYM file
* [LookinServer](https://github.com/QMUI/LookinServer) ⭐ 2,865 | 🐛 40 | 🌐 Objective-C | 📅 2024-07-17 Free macOS app for iOS view debugging
* [InAppViewDebugger](https://github.com/indragiek/InAppViewDebugger) ⭐ 1,920 | 🐛 2 | 🌐 Swift | 📅 2024-01-02 A UIView debugger (like Reveal or Xcode) that can be embedded in an app for on-device view debugging
* [XCLogParser](https://github.com/spotify/XCLogParser) ⭐ 1,852 | 🐛 38 | 🌐 Swift | 📅 2026-07-07 Tool to parse the SLF serialization format used by Xcode and xcodebuild to store its Build and Test logs (xcactivitylog).
* [MTHawkeye](https://github.com/meitu/MTHawkeye) ⭐ 1,505 | 🐛 8 | 🌐 Objective-C | 📅 2023-11-17 Profiling / Debugging assist tools for iOS.
* [restore-symbol](https://github.com/tobefuturer/restore-symbol) ⭐ 1,338 | 🐛 18 | 🌐 Objective-C | 📅 2020-08-21 A reverse engineering tool to restore stripped symbol table for iOS app.
...
* [DBDebugToolkit](https://github.com/dbukowski/DBDebugToolkit) ⭐ 1,277 | 🐛 16 | 🌐 Objective-C | 📅 2024-05-31 Set of easy to use debugging tools for iOS developers & QA engineers.
...
* [Instruments](https://developer.apple.com/library/content/documentation/DeveloperTools/Conceptual/InstrumentsUserGuide/index.html) Instruments is a powerful and flexible performance-analysis and testing tool that’s part of the Xcode tool set.
  * [speedscope](https://github.com/jlfwong/speedscope) ⭐ 6,750 | 🐛 159 | 🌐 TypeScript | 📅 2026-05-15 Flame graphs of Time Profiler
...
* [FBRetainCycleDetector](https://github.com/facebook/FBRetainCycleDetector) ⭐ 4,227 | 🐛 43 | 🌐 Objective-C++ | 📅 2026-08-19 iOS library to help detecting retain cycles in runtime.
...
* [OOMDetector](https://github.com/Tencent/OOMDetector) ⭐ 2,346 | 🐛 38 | 🌐 Objective-C++ | 📅 2023-02-21 OOMDetector is a memory monitoring component for iOS which provides you with OOM monitoring, memory allocation monitoring, memory leak detection and other functions.
...
* [swiftlint](https://github.com/realm/SwiftLint) ⭐ 19,726 | 🐛 501 | 🌐 Swift | 📅 2026-09-03 A tool to enforce Swift style and conventions.
...
* [AssetCatalogTinkerer](https://github.com/insidegui/AssetCatalogTinkerer) ⭐ 2,882 | 🐛 13 | 🌐 Swift | 📅 2026-04-27 An app that lets you open .car files and browse/extract their images.
* [xcodeproj](https://github.com/tuist/xcodeproj) ⭐ 2,225 | 🐛 20 | 🌐 Swift | 📅 2026-09-11 📝 Read, update and write your Xcode projects <https://tuist.github.io/xcodeproj/>
...
* [Pecker](https://github.com/woshiccm/Pecker.git) ⭐ 1,459 | 🐛 12 | 🌐 Swift | 📅 2022-04-08 A tool to detect unused Swift code based on [IndexStoreDB](https://github.com/apple/indexstore-db.git) ⭐ 419 | 🐛 16 | 🌐 C++ | 📅 2026-09-12 and [SwiftSyntax](https://github.com/apple/swift-syntax.git) ⭐ 3,699 | 🐛 186 | 🌐 Swift | 📅 2026-09-14.
...
* [XcodeZombieCode](https://github.com/kangwang1988/XcodeZombieCode) ⭐ 233 | 🐛 1 | 🌐 C++ | 📅 2018-08-22 A source-code level/Clang Approach
...
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,969 | 🐛 40 | 🌐 Dart | 📅 2026-09-14 Lantern delivers fast access to the open Internet
* [iperf](https://github.com/esnet/iperf) ⭐ 8,756 | 🐛 238 | 🌐 C | 📅 2026-07-10 iperf3: A TCP, UDP, and SCTP network bandwidth measurement tool
...
* [Wormholy](https://github.com/pmusolino/Wormholy) ⭐ 2,617 | 🐛 13 | 🌐 Swift | 📅 2026-05-23 iOS network debugging
...
* [SQLCipher](https://github.com/sqlcipher/sqlcipher) ⭐ 7,273 | 🐛 9 | 🌐 C | 📅 2026-09-08 SQLCipher is an SQLite extension that provides 256 bit AES encryption of database files
* [SimSim](https://github.com/dsmelov/simsim) ⭐ 1,478 | 🐛 6 | 🌐 Swift | 📅 2023-01-23 Fast, stable, free alternative to SimPholders
...
* [emscripten](https://github.com/kripken/emscripten) ⭐ 27,611 | 🐛 2,486 | 🌐 C++ | 📅 2026-09-14 An LLVM-to-JavaScript Compiler
* [bazel](https://github.com/bazelbuild/bazel) ⭐ 25,845 | 🐛 1,777 | 🌐 Java | 📅 2026-09-14 A fast, scalable, multi-language and extensible build system
...
* [antlr4](https://github.com/antlr/antlr4) ⭐ 19,002 | 🐛 1,089 | 🌐 Java | 📅 2026-02-16 ANTLR (ANother Tool for Language Recognition) is a powerful parser generator for reading, processing, executing, or translating structured text or binary files. <http://antlr.org>
...
* [swiff](https://github.com/agens-no/swiff) ⭐ 795 | 🐛 2 | 🌐 Swift | 📅 2022-04-21 Human readable time diffs on lines of output when running e.g. build commands like fastlane
* [ClangKit](https://github.com/macmade/ClangKit) ⭐ 367 | 🐛 3 | 🌐 C | 📅 2021-08-02 ClangKit provides an Objective-C frontend to LibClang. Source tokenization, diagnostics and fix-its are actually implemented.
...
* [libimobiledevice](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,186 | 🐛 846 | 🌐 C | 📅 2026-06-10 A cross-platform protocol library to communicate with iOS devices
...
* [EarlGrey](https://github.com/google/EarlGrey) ⭐ 5,693 | 🐛 259 | 🌐 Objective-C | 📅 2026-09-11 🍵 iOS UI Automation Test Framework
* [swift-snapshot-testing](https://github.com/pointfreeco/swift-snapshot-testing) ⭐ 4,334 | 🐛 221 | 🌐 Swift | 📅 2026-08-24 📸 Delightful Swift snapshot testing
* [Kiwi](https://github.com/kiwi-bdd/Kiwi) ⭐ 4,109 | 🐛 89 | 🌐 Objective-C | 📅 2023-09-05 Simple BDD for iOS
...
* [Specta](https://github.com/specta/specta) ⭐ 2,310 | 🐛 18 | 🌐 Objective-C | 📅 2022-02-27 A light-weight TDD / BDD framework for Objective-C.
* [OCMock](https://github.com/erikdoe/ocmock) ⭐ 2,170 | 🐛 50 | 🌐 Objective-C | 📅 2024-06-30 Mock objects for Objective-C
...
* [usbmuxd](https://github.com/libimobiledevice/usbmuxd) ⭐ 1,763 | 🐛 117 | 🌐 C | 📅 2025-12-06 A socket daemon to multiplex connections from and to iOS devices
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,384 | 🐛 57 | 🌐 Python | 📅 2026-07-23 Assess mobile applications and their security posture without the need for a jailbroken or rooted mobile device.
* [capstone](https://github.com/aquynh/capstone) ⭐ 9,020 | 🐛 358 | 🌐 C | 📅 2026-09-10 Capstone disassembly/disassembler framework
...
* [ios-app-signer](https://github.com/DanTheMan827/ios-app-signer) ⭐ 6,319 | 🐛 124 | 🌐 Objective-C | 📅 2025-09-01 This is an app for OS X that can (re)sign apps and bundle them into ipa files that are ready to be installed on an iOS device.
...
* [theos](https://github.com/theos/theos) ⭐ 4,918 | 🐛 72 | 🌐 Makefile | 📅 2026-08-08 Unified cross-platform Makefile system
* [Clutch](https://github.com/KJCracks/Clutch) ⭐ 3,823 | 🐛 43 | 🌐 Objective-C | 📅 2024-11-15 Fast iOS executable dumper
* [iReSign](https://github.com/maciekish/iReSign) ⭐ 3,614 | 🐛 81 | 🌐 Objective-C | 📅 2023-12-01 iReSign allows iDevice app bundles (.ipa) files to be signed or resigned with a digital certificate from Apple for distribution.
* [dumpdecrypted](https://github.com/stefanesser/dumpdecrypted) ⭐ 3,036 | 🐛 21 | 🌐 C | 📅 2017-10-26 Dumps decrypted mach-o files from encrypted iPhone applications from memory to disk. This tool is necessary for security researchers to be able to look under the hood of encryption.
* [MachOView](https://github.com/gdbinit/MachOView) ⭐ 2,871 | 🐛 16 | 🌐 C | 📅 2024-07-22 View the raw data of mach-o(iOS executable file format)
* [Hikari](https://github.com/HikariObfuscator/Hikari) ⚠️ Archived LLVM Obfuscator <https://keybase.io/team/hikari>
* [insert\_dylib](https://github.com/Tyilo/insert_dylib) ⭐ 2,097 | 🐛 2 | 🌐 C | 📅 2025-03-29 Command line utility for inserting a dylib load command into a Mach-O binary
...
* [Keychain-Dumper](https://github.com/ptoomey3/Keychain-Dumper) ⭐ 1,422 | 🐛 19 | 🌐 Objective-C | 📅 2024-08-15A tool to check which keychain items are available to an attacker once an iOS device has been jailbroken
* [optool](https://github.com/alexzielenski/optool) ⭐ 1,287 | 🐛 13 | 🌐 Objective-C | 📅 2019-09-06 optool is a tool which interfaces with MachO binaries in order to insert/remove load commands, strip code signatures, resign, and remove aslr. Below is its help.
...
* [yololib](https://github.com/KJCracks/yololib) ⭐ 975 | 🐛 10 | 🌐 Objective-C | 📅 2016-04-29 dylib injector for mach-o binaries
...
* [ruby-macho](https://github.com/Homebrew/ruby-macho) ⭐ 262 | 🐛 0 | 🌐 Ruby | 📅 2026-09-11 🔩 A pure-Ruby library for parsing Mach-O files.
...
* [obfuscator](https://github.com/obfuscator-llvm/obfuscator) ⭐ 4,394 | 🐛 97 | 📅 2023-10-20 obfuscator
* [swiftshield](https://github.com/rockbruno/swiftshield) ⭐ 2,549 | 🐛 58 | 🌐 Swift | 📅 2022-11-20 Swift Obfuscator that protects iOS apps against reverse engineering attacks.
...
* [MachObfuscator](https://github.com/kam800/MachObfuscator) ⭐ 544 | 🐛 20 | 🌐 Swift | 📅 2022-10-08 MachObfuscator is a programming-language-agnostic Mach-O apps obfuscator for Apple platforms.
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,110 | 🐛 670 | 🌐 Ruby | 📅 2026-09-14 Automate building and releasing your iOS and Android apps
* [UTM](https://github.com/utmapp/UTM) ⭐ 35,480 | 🐛 1,119 | 🌐 Swift | 📅 2026-09-02 Virtual machines for iOS
* [lottie-ios](https://github.com/airbnb/lottie-ios) ⭐ 26,875 | 🐛 44 | 🌐 Swift | 📅 2026-09-02 An iOS library to natively render After Effects vector animations
* [jazzy](https://github.com/realm/jazzy) ⭐ 7,378 | 🐛 76 | 🌐 Ruby | 📅 2026-09-14 Soulful docs for Swift & Objective-C
* [danger](https://github.com/danger/danger) ⭐ 5,690 | 🐛 165 | 🌐 Ruby | 📅 2026-07-29 Formalize your Pull Request etiquette.
* [public-apis](https://github.com/toddmotto/public-apis) ⭐ 2,743 | 🐛 13 | 📅 2024-06-23 A collective list of public JSON APIs。
