...
* [CocoaPods](http://cocoapods.org/) dependency manager for Swift and Objective-C Cocoa projects
  ...
  * [cocoapods-static-swift-framework](https://github.com/leavez/cocoapods-static-swift-framework) ⭐ 252 | 🐛 6 | 🌐 Ruby | 📅 2022-07-22 A cocoapods plugin enables static framework for all pods
...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,786 | 🐛 311 | 🌐 Shell | 📅 2026-09-18 A delightful community-driven (with 1,300+ contributors) framework for managing your zsh configuration.
* [brew](https://github.com/Homebrew/brew) ⭐ 49,708 | 🐛 2 | 🌐 Ruby | 📅 2026-09-18 🍺 The missing package manager for macOS
* [tmux](https://github.com/tmux/tmux) ⭐ 49,327 | 🐛 47 | 🌐 C | 📅 2026-09-17 tmux is a "terminal multiplexer", it enables a number of terminals (or windows)
  to be accessed and controlled from a single terminal.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,544 | 🐛 27 | 🌐 Perl | 📅 2026-09-14 cloc counts blank lines, comment lines, and physical lines of source code in many programming languages.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,926 | 🐛 292 | 🌐 Swift | 📅 2026-09-16 A code library and command-line formatting tool for reformatting Swift code
* [XcodeGen](https://github.com/yonaskolb/XcodeGen) ⭐ 8,786 | 🐛 404 | 🌐 Swift | 📅 2026-09-13 A Swift command line tool for generating your Xcode project
* [Jazzy](https://github.com/realm/jazzy) ⭐ 7,379 | 🐛 76 | 🌐 Ruby | 📅 2026-09-14 Soulful docs for Swift & Objective-C
...
* [synx](https://github.com/venmo/synx) ⭐ 6,036 | 🐛 56 | 🌐 Ruby | 📅 2019-07-18 A command-line tool that reorganizes your Xcode project folder to match your Xcode groups
* [idb](https://github.com/facebook/idb) ⭐ 5,335 | 🐛 174 | 🌐 Swift | 📅 2026-09-18 idb is a flexible command line interface for automating iOS simulators and devices
* [xcpretty](https://github.com/supermarin/xcpretty) ⭐ 4,035 | 🐛 120 | 🌐 Ruby | 📅 2025-03-26 Flexible and fast xcodebuild formatter
* [swift-argument-parser](https://github.com/apple/swift-argument-parser) ⭐ 3,769 | 🐛 141 | 🌐 Swift | 📅 2026-09-16 Open-source library that makes it straightforward to parse command-line arguments in Swift
...
* [DoraemonKit](https://github.com/didi/DoraemonKit) ⭐ 20,415 | 🐛 275 | 🌐 Java | 📅 2026-09-07 A full-featured App (iOS & Android) development assistant.
* [FLEX](https://github.com/Flipboard/FLEX) ⭐ 14,637 | 🐛 50 | 🌐 Objective-C | 📅 2026-06-11 An in-app debugging and exploration tool for iOS
* [CocoaLumberjack](https://github.com/CocoaLumberjack/CocoaLumberjack) ⭐ 13,321 | 🐛 7 | 🌐 Objective-C | 📅 2026-09-16 A fast & simple, yet powerful & flexible logging framework for Mac and iOS
* [matrix](https://github.com/Tencent/matrix) ⭐ 12,050 | 🐛 408 | 🌐 Java | 📅 2024-07-23 Matrix is a plugin style, non-invasive APM system developed by WeChat.
...
* [injectionforxcode](https://github.com/johnno1962/injectionforxcode) ⭐ 6,535 | 🐛 76 | 🌐 Objective-C | 📅 2022-08-04 Injection for Xcode is an Xcode plugin (available via Alcatraz) or AppCode that dynamically inserts new Swift / Objective-C code into a running app in order to speed up your build process
...
* [KSCrash](https://github.com/kstenerud/KSCrash) ⭐ 4,495 | 🐛 22 | 🌐 Objective-C | 📅 2026-09-18 The Ultimate iOS Crash Reporter
...
* [LookinServer](https://github.com/QMUI/LookinServer) ⭐ 2,866 | 🐛 40 | 🌐 Objective-C | 📅 2024-07-17 Free macOS app for iOS view debugging
...
* [Instruments](https://developer.apple.com/library/content/documentation/DeveloperTools/Conceptual/InstrumentsUserGuide/index.html) Instruments is a powerful and flexible performance-analysis and testing tool that’s part of the Xcode tool set.
  * [speedscope](https://github.com/jlfwong/speedscope) ⭐ 6,752 | 🐛 159 | 🌐 TypeScript | 📅 2026-05-15 Flame graphs of Time Profiler
...
* [swiftlint](https://github.com/realm/SwiftLint) ⭐ 19,738 | 🐛 503 | 🌐 Swift | 📅 2026-09-03 A tool to enforce Swift style and conventions.
...
* [AssetCatalogTinkerer](https://github.com/insidegui/AssetCatalogTinkerer) ⭐ 2,884 | 🐛 13 | 🌐 Swift | 📅 2026-04-27 An app that lets you open .car files and browse/extract their images.
* [xcodeproj](https://github.com/tuist/xcodeproj) ⭐ 2,224 | 🐛 16 | 🌐 Swift | 📅 2026-09-18 📝 Read, update and write your Xcode projects <https://tuist.github.io/xcodeproj/>
...
* [Pecker](https://github.com/woshiccm/Pecker.git) ⭐ 1,459 | 🐛 12 | 🌐 Swift | 📅 2022-04-08 A tool to detect unused Swift code based on [IndexStoreDB](https://github.com/apple/indexstore-db.git) ⭐ 419 | 🐛 16 | 🌐 C++ | 📅 2026-09-17 and [SwiftSyntax](https://github.com/apple/swift-syntax.git) ⭐ 3,700 | 🐛 189 | 🌐 Swift | 📅 2026-09-18.
...
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,986 | 🐛 45 | 🌐 Dart | 📅 2026-09-18 Lantern delivers fast access to the open Internet
* [iperf](https://github.com/esnet/iperf) ⭐ 8,767 | 🐛 238 | 🌐 C | 📅 2026-07-10 iperf3: A TCP, UDP, and SCTP network bandwidth measurement tool
...
* [SQLCipher](https://github.com/sqlcipher/sqlcipher) ⭐ 7,278 | 🐛 9 | 🌐 C | 📅 2026-09-15 SQLCipher is an SQLite extension that provides 256 bit AES encryption of database files
...
* [emscripten](https://github.com/kripken/emscripten) ⭐ 27,614 | 🐛 2,480 | 🌐 C++ | 📅 2026-09-18 An LLVM-to-JavaScript Compiler
* [bazel](https://github.com/bazelbuild/bazel) ⭐ 25,861 | 🐛 1,768 | 🌐 Java | 📅 2026-09-18 A fast, scalable, multi-language and extensible build system
...
* [libimobiledevice](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,197 | 🐛 846 | 🌐 C | 📅 2026-06-10 A cross-platform protocol library to communicate with iOS devices
* [KIF](https://github.com/kif-framework/KIF) ⭐ 6,246 | 🐛 56 | 🌐 Objective-C | 📅 2026-08-13 Keep It Functional - An iOS Functional Testing Framework
* [EarlGrey](https://github.com/google/EarlGrey) ⭐ 5,692 | 🐛 259 | 🌐 Objective-C | 📅 2026-09-15 🍵 iOS UI Automation Test Framework
* [swift-snapshot-testing](https://github.com/pointfreeco/swift-snapshot-testing) ⭐ 4,338 | 🐛 220 | 🌐 Swift | 📅 2026-09-15 📸 Delightful Swift snapshot testing
...
* [Specta](https://github.com/specta/specta) ⭐ 2,307 | 🐛 18 | 🌐 Objective-C | 📅 2022-02-27 A light-weight TDD / BDD framework for Objective-C.
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,395 | 🐛 57 | 🌐 Python | 📅 2026-09-17 Assess mobile applications and their security posture without the need for a jailbroken or rooted mobile device.
* [capstone](https://github.com/aquynh/capstone) ⭐ 9,025 | 🐛 354 | 🌐 C | 📅 2026-09-18 Capstone disassembly/disassembler framework
...
* [theos](https://github.com/theos/theos) ⭐ 4,918 | 🐛 72 | 🌐 Makefile | 📅 2026-09-18 Unified cross-platform Makefile system
...
* [MachOView](https://github.com/gdbinit/MachOView) ⭐ 2,869 | 🐛 16 | 🌐 C | 📅 2024-07-22 View the raw data of mach-o(iOS executable file format)
...
* [Keychain-Dumper](https://github.com/ptoomey3/Keychain-Dumper) ⭐ 1,423 | 🐛 19 | 🌐 Objective-C | 📅 2024-08-15A tool to check which keychain items are available to an attacker once an iOS device has been jailbroken
...
* [ruby-macho](https://github.com/Homebrew/ruby-macho) ⭐ 261 | 🐛 0 | 🌐 Ruby | 📅 2026-09-18 🔩 A pure-Ruby library for parsing Mach-O files.
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,125 | 🐛 669 | 🌐 Ruby | 📅 2026-09-17 Automate building and releasing your iOS and Android apps
* [UTM](https://github.com/utmapp/UTM) ⭐ 35,542 | 🐛 1,120 | 🌐 Swift | 📅 2026-09-18 Virtual machines for iOS
* [lottie-ios](https://github.com/airbnb/lottie-ios) ⭐ 26,881 | 🐛 46 | 🌐 Swift | 📅 2026-09-02 An iOS library to natively render After Effects vector animations
* [jazzy](https://github.com/realm/jazzy) ⭐ 7,379 | 🐛 76 | 🌐 Ruby | 📅 2026-09-14 Soulful docs for Swift & Objective-C
