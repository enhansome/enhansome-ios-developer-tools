...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,140 | 🐛 574 | 🌐 Shell | 📅 2026-08-11 A delightful community-driven (with 1,300+ contributors) framework for managing your zsh configuration.
* [brew](https://github.com/Homebrew/brew) ⭐ 49,139 | 🐛 8 | 🌐 Ruby | 📅 2026-08-12 🍺 The missing package manager for macOS
* [tmux](https://github.com/tmux/tmux) ⭐ 48,581 | 🐛 44 | 🌐 C | 📅 2026-08-12 tmux is a "terminal multiplexer", it enables a number of terminals (or windows)
  to be accessed and controlled from a single terminal.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,427 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 cloc counts blank lines, comment lines, and physical lines of source code in many programming languages.
...
* [idb](https://github.com/facebook/idb) ⭐ 5,271 | 🐛 182 | 🌐 Swift | 📅 2026-08-12 idb is a flexible command line interface for automating iOS simulators and devices
...
* [ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,192 | 🐛 19 | 🌐 C | 📅 2025-07-02 A DevTools proxy (Chrome Remote Debugging Protocol) for iOS devices (Safari Remote Web Inspector).
...
* [swiftlint](https://github.com/realm/SwiftLint) ⭐ 19,699 | 🐛 489 | 🌐 Swift | 📅 2026-08-09 A tool to enforce Swift style and conventions.
...
* [AssetCatalogTinkerer](https://github.com/insidegui/AssetCatalogTinkerer) ⭐ 2,869 | 🐛 13 | 🌐 Swift | 📅 2026-04-27 An app that lets you open .car files and browse/extract their images.
...
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,867 | 🐛 47 | 🌐 Dart | 📅 2026-08-13 Lantern delivers fast access to the open Internet
* [iperf](https://github.com/esnet/iperf) ⭐ 8,684 | 🐛 236 | 🌐 C | 📅 2026-07-10 iperf3: A TCP, UDP, and SCTP network bandwidth measurement tool
...
* [SQLCipher](https://github.com/sqlcipher/sqlcipher) ⭐ 7,235 | 🐛 10 | 🌐 C | 📅 2026-07-08 SQLCipher is an SQLite extension that provides 256 bit AES encryption of database files
...
* [emscripten](https://github.com/kripken/emscripten) ⭐ 27,568 | 🐛 2,463 | 🌐 C++ | 📅 2026-08-12 An LLVM-to-JavaScript Compiler
* [bazel](https://github.com/bazelbuild/bazel) ⭐ 25,701 | 🐛 1,922 | 🌐 Java | 📅 2026-08-12 A fast, scalable, multi-language and extensible build system
...
* [antlr4](https://github.com/antlr/antlr4) ⭐ 18,979 | 🐛 1,086 | 🌐 Java | 📅 2026-02-16 ANTLR (ANother Tool for Language Recognition) is a powerful parser generator for reading, processing, executing, or translating structured text or binary files. <http://antlr.org>
...
* [libimobiledevice](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,101 | 🐛 840 | 🌐 C | 📅 2026-06-10 A cross-platform protocol library to communicate with iOS devices
* [KIF](https://github.com/kif-framework/KIF) ⭐ 6,244 | 🐛 54 | 🌐 Objective-C | 📅 2026-08-10 Keep It Functional - An iOS Functional Testing Framework
* [EarlGrey](https://github.com/google/EarlGrey) ⭐ 5,688 | 🐛 253 | 🌐 Objective-C | 📅 2026-08-10 🍵 iOS UI Automation Test Framework
...
* [capstone](https://github.com/aquynh/capstone) ⭐ 8,945 | 🐛 360 | 🌐 C | 📅 2026-08-12 Capstone disassembly/disassembler framework
...
* [theos](https://github.com/theos/theos) ⭐ 4,902 | 🐛 73 | 🌐 Makefile | 📅 2026-08-08 Unified cross-platform Makefile system
...
* [dumpdecrypted](https://github.com/stefanesser/dumpdecrypted) ⭐ 3,030 | 🐛 21 | 🌐 C | 📅 2017-10-26 Dumps decrypted mach-o files from encrypted iPhone applications from memory to disk. This tool is necessary for security researchers to be able to look under the hood of encryption.
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 41,985 | 🐛 680 | 🌐 Ruby | 📅 2026-08-13 Automate building and releasing your iOS and Android apps
* [UTM](https://github.com/utmapp/UTM) ⭐ 34,985 | 🐛 1,092 | 🌐 Swift | 📅 2026-08-05 Virtual machines for iOS
* [lottie-ios](https://github.com/airbnb/lottie-ios) ⭐ 26,827 | 🐛 44 | 🌐 Swift | 📅 2026-07-08 An iOS library to natively render After Effects vector animations
* [jazzy](https://github.com/realm/jazzy) ⭐ 7,381 | 🐛 75 | 🌐 Ruby | 📅 2026-06-30 Soulful docs for Swift & Objective-C
