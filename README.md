...
* [oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/) ⭐ 189,749 | 🐛 311 | 🌐 Shell | 📅 2026-09-16 A delightful community-driven (with 1,300+ contributors) framework for managing your zsh configuration.
* [brew](https://github.com/Homebrew/brew) ⭐ 49,677 | 🐛 7 | 🌐 Ruby | 📅 2026-09-16 🍺 The missing package manager for macOS
* [tmux](https://github.com/tmux/tmux) ⭐ 49,291 | 🐛 40 | 🌐 C | 📅 2026-09-15 tmux is a "terminal multiplexer", it enables a number of terminals (or windows)
  to be accessed and controlled from a single terminal.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,536 | 🐛 27 | 🌐 Perl | 📅 2026-09-14 cloc counts blank lines, comment lines, and physical lines of source code in many programming languages.
* [autojump](https://github.com/wting/autojump) ⭐ 16,958 | 🐛 232 | 🌐 Python | 📅 2025-02-27 A cd command that learns - easily navigate directories from the command line
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,931 | 🐛 293 | 🌐 Swift | 📅 2026-09-16 A code library and command-line formatting tool for reformatting Swift code
* [XcodeGen](https://github.com/yonaskolb/XcodeGen) ⭐ 8,784 | 🐛 401 | 🌐 Swift | 📅 2026-09-13 A Swift command line tool for generating your Xcode project
...
* [idb](https://github.com/facebook/idb) ⭐ 5,331 | 🐛 179 | 🌐 Swift | 📅 2026-09-16 idb is a flexible command line interface for automating iOS simulators and devices
* [xcpretty](https://github.com/supermarin/xcpretty) ⭐ 4,035 | 🐛 120 | 🌐 Ruby | 📅 2025-03-26 Flexible and fast xcodebuild formatter
* [swift-argument-parser](https://github.com/apple/swift-argument-parser) ⭐ 3,768 | 🐛 141 | 🌐 Swift | 📅 2026-09-14 Open-source library that makes it straightforward to parse command-line arguments in Swift
...
* [DoraemonKit](https://github.com/didi/DoraemonKit) ⭐ 20,408 | 🐛 275 | 🌐 Java | 📅 2026-09-07 A full-featured App (iOS & Android) development assistant.
* [FLEX](https://github.com/Flipboard/FLEX) ⭐ 14,635 | 🐛 50 | 🌐 Objective-C | 📅 2026-06-11 An in-app debugging and exploration tool for iOS
* [CocoaLumberjack](https://github.com/CocoaLumberjack/CocoaLumberjack) ⭐ 13,319 | 🐛 7 | 🌐 Objective-C | 📅 2026-09-16 A fast & simple, yet powerful & flexible logging framework for Mac and iOS
...
* [injectionforxcode](https://github.com/johnno1962/injectionforxcode) ⭐ 6,536 | 🐛 76 | 🌐 Objective-C | 📅 2022-08-04 Injection for Xcode is an Xcode plugin (available via Alcatraz) or AppCode that dynamically inserts new Swift / Objective-C code into a running app in order to speed up your build process
...
* [ios-webkit-debug-proxy](https://github.com/google/ios-webkit-debug-proxy) ⭐ 6,205 | 🐛 20 | 🌐 C | 📅 2025-07-02 A DevTools proxy (Chrome Remote Debugging Protocol) for iOS devices (Safari Remote Web Inspector).
...
* [KSCrash](https://github.com/kstenerud/KSCrash) ⭐ 4,494 | 🐛 18 | 🌐 Objective-C | 📅 2026-09-15 The Ultimate iOS Crash Reporter
...
* [restore-symbol](https://github.com/tobefuturer/restore-symbol) ⭐ 1,337 | 🐛 18 | 🌐 Objective-C | 📅 2020-08-21 A reverse engineering tool to restore stripped symbol table for iOS app.
* [WBWebViewConsole](https://github.com/Naituw/WBWebViewConsole) ⭐ 1,324 | 🐛 7 | 🌐 Objective-C | 📅 2017-08-08 In-App debug console for your UIWebView & WKWebView
...
* [swiftlint](https://github.com/realm/SwiftLint) ⭐ 19,734 | 🐛 502 | 🌐 Swift | 📅 2026-09-03 A tool to enforce Swift style and conventions.
...
* [AssetCatalogTinkerer](https://github.com/insidegui/AssetCatalogTinkerer) ⭐ 2,883 | 🐛 13 | 🌐 Swift | 📅 2026-04-27 An app that lets you open .car files and browse/extract their images.
* [xcodeproj](https://github.com/tuist/xcodeproj) ⭐ 2,225 | 🐛 20 | 🌐 Swift | 📅 2026-09-15 📝 Read, update and write your Xcode projects <https://tuist.github.io/xcodeproj/>
...
* [Pecker](https://github.com/woshiccm/Pecker.git) ⭐ 1,460 | 🐛 12 | 🌐 Swift | 📅 2022-04-08 A tool to detect unused Swift code based on [IndexStoreDB](https://github.com/apple/indexstore-db.git) ⭐ 419 | 🐛 16 | 🌐 C++ | 📅 2026-09-16 and [SwiftSyntax](https://github.com/apple/swift-syntax.git) ⭐ 3,700 | 🐛 191 | 🌐 Swift | 📅 2026-09-16.
...
* [Lantern](https://github.com/getlantern/lantern) ⭐ 15,976 | 🐛 38 | 🌐 Dart | 📅 2026-09-16 Lantern delivers fast access to the open Internet
* [iperf](https://github.com/esnet/iperf) ⭐ 8,761 | 🐛 238 | 🌐 C | 📅 2026-07-10 iperf3: A TCP, UDP, and SCTP network bandwidth measurement tool
...
* [SQLCipher](https://github.com/sqlcipher/sqlcipher) ⭐ 7,275 | 🐛 9 | 🌐 C | 📅 2026-09-15 SQLCipher is an SQLite extension that provides 256 bit AES encryption of database files
...
* [emscripten](https://github.com/kripken/emscripten) ⭐ 27,612 | 🐛 2,488 | 🌐 C++ | 📅 2026-09-16 An LLVM-to-JavaScript Compiler
* [bazel](https://github.com/bazelbuild/bazel) ⭐ 25,857 | 🐛 1,758 | 🌐 Java | 📅 2026-09-16 A fast, scalable, multi-language and extensible build system
...
* [antlr4](https://github.com/antlr/antlr4) ⭐ 19,004 | 🐛 1,089 | 🌐 Java | 📅 2026-02-16 ANTLR (ANother Tool for Language Recognition) is a powerful parser generator for reading, processing, executing, or translating structured text or binary files. <http://antlr.org>
...
* [Quick](https://github.com/Quick/Quick) ⭐ 9,826 | 🐛 49 | 🌐 Swift | 📅 2026-05-18 The Swift (and Objective-C) testing framework.
* [libimobiledevice](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,191 | 🐛 846 | 🌐 C | 📅 2026-06-10 A cross-platform protocol library to communicate with iOS devices
...
* [EarlGrey](https://github.com/google/EarlGrey) ⭐ 5,692 | 🐛 259 | 🌐 Objective-C | 📅 2026-09-15 🍵 iOS UI Automation Test Framework
* [swift-snapshot-testing](https://github.com/pointfreeco/swift-snapshot-testing) ⭐ 4,335 | 🐛 219 | 🌐 Swift | 📅 2026-09-15 📸 Delightful Swift snapshot testing
* [Kiwi](https://github.com/kiwi-bdd/Kiwi) ⭐ 4,108 | 🐛 89 | 🌐 Objective-C | 📅 2023-09-05 Simple BDD for iOS
...
* [Specta](https://github.com/specta/specta) ⭐ 2,309 | 🐛 18 | 🌐 Objective-C | 📅 2022-02-27 A light-weight TDD / BDD framework for Objective-C.
* [OCMock](https://github.com/erikdoe/ocmock) ⭐ 2,169 | 🐛 50 | 🌐 Objective-C | 📅 2024-06-30 Mock objects for Objective-C
...
* [usbmuxd](https://github.com/libimobiledevice/usbmuxd) ⭐ 1,766 | 🐛 118 | 🌐 C | 📅 2025-12-06 A socket daemon to multiplex connections from and to iOS devices
...
* [objection](https://github.com/sensepost/objection) ⭐ 9,391 | 🐛 58 | 🌐 Python | 📅 2026-07-23 Assess mobile applications and their security posture without the need for a jailbroken or rooted mobile device.
* [capstone](https://github.com/aquynh/capstone) ⭐ 9,026 | 🐛 357 | 🌐 C | 📅 2026-09-15 Capstone disassembly/disassembler framework
...
* [fishhook](https://github.com/facebook/fishhook) ⭐ 5,429 | 🐛 39 | 🌐 C | 📅 2024-08-01 A library that enables dynamically rebinding symbols in Mach-O binaries running on iOS. You can use fishhook to hook C function.
...
* [insert\_dylib](https://github.com/Tyilo/insert_dylib) ⭐ 2,096 | 🐛 2 | 🌐 C | 📅 2025-03-29 Command line utility for inserting a dylib load command into a Mach-O binary
...
* [iOS-System-Symbols](https://github.com/Zuikyo/iOS-System-Symbols) ⭐ 1,078 | 🐛 2 | 🌐 Shell | 📅 2022-08-28 Share iOS system framework's symbol files. Useful for symbolicating iOS crash report.
* [yololib](https://github.com/KJCracks/yololib) ⭐ 974 | 🐛 10 | 🌐 Objective-C | 📅 2016-04-29 dylib injector for mach-o binaries
...
* [obfuscator](https://github.com/obfuscator-llvm/obfuscator) ⭐ 4,395 | 🐛 97 | 📅 2023-10-20 obfuscator
...
* [ios-class-guard](https://github.com/Polidea/ios-class-guard) ⭐ 1,662 | 🐛 35 | 🌐 Objective-C | 📅 2020-01-04 Simple Objective-C obfuscator for Mach-O executables
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,115 | 🐛 667 | 🌐 Ruby | 📅 2026-09-16 Automate building and releasing your iOS and Android apps
* [UTM](https://github.com/utmapp/UTM) ⭐ 35,513 | 🐛 1,120 | 🌐 Swift | 📅 2026-09-16 Virtual machines for iOS
* [lottie-ios](https://github.com/airbnb/lottie-ios) ⭐ 26,877 | 🐛 45 | 🌐 Swift | 📅 2026-09-02 An iOS library to natively render After Effects vector animations
* [jazzy](https://github.com/realm/jazzy) ⭐ 7,378 | 🐛 76 | 🌐 Ruby | 📅 2026-09-14 Soulful docs for Swift & Objective-C
